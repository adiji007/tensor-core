...
add wave -noupdate -expand -group dispatch /system_tb/DUT/DP/SCOREBOARD/diif/fetch
...
add wave -noupdate -expand -group dispatch /system_tb/DUT/DP/SCOREBOARD/diif/wb
...
add wave -noupdate -expand -group issue /system_tb/DUT/DP/SCOREBOARD/isif/out
...
WaveRestoreCursors {{Cursor 1} {11299958 ns} 0}
...
update
WaveRestoreZoom {11299901 ns} {11300143 ns}
