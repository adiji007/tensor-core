...
add wave -noupdate -color Gold -childformat {{/scoreboard_tb/DUT/sbif/out.rd -radix unsigned} {/scoreboard_tb/DUT/sbif/out.rdat1 -radix decimal} {/scoreboard_tb/DUT/sbif/out.rdat2 -radix decimal} {/scoreboard_tb/DUT/sbif/out.imm -radix decimal} {/scoreboard_tb/DUT/sbif/out.branch_pc -radix decimal}} -expand -subitemconfig {/scoreboard_tb/DUT/sbif/out.fu_en {-color Gold -height 16 -expand} {/scoreboard_tb/DUT/sbif/out.fu_en[4]} {-color Gold} {/scoreboard_tb/DUT/sbif/out.fu_en[3]} {-color Gold} {/scoreboard_tb/DUT/sbif/out.fu_en[2]} {-color Gold} {/scoreboard_tb/DUT/sbif/out.fu_en[1]} {-color Gold} {/scoreboard_tb/DUT/sbif/out.fu_en[0]} {-color Gold} /scoreboard_tb/DUT/sbif/out.rd {-color Gold -height 16 -radix unsigned} /scoreboard_tb/DUT/sbif/out.rdat1 {-color Gold -height 16 -radix decimal} /scoreboard_tb/DUT/sbif/out.rdat2 {-color Gold -height 16 -radix decimal} /scoreboard_tb/DUT/sbif/out.imm {-color Gold -height 16 -radix decimal} /scoreboard_tb/DUT/sbif/out.branch_type {-color Gold -height 16} /scoreboard_tb/DUT/sbif/out.branch_pc {-color Gold -height 16 -radix decimal} /scoreboard_tb/DUT/sbif/out.branch_pred_pc {-color Gold -height 16} /scoreboard_tb/DUT/sbif/out.j_type {-color Gold -height 16} /scoreboard_tb/DUT/sbif/out.alu_op {-color Gold -height 16} /scoreboard_tb/DUT/sbif/out.ls_in {-color Gold -height 16} /scoreboard_tb/DUT/sbif/out.mem_type {-color Gold -height 16} /scoreboard_tb/DUT/sbif/out.md {-color Gold -height 16} /scoreboard_tb/DUT/sbif/out.ms1 {-color Gold -height 16} /scoreboard_tb/DUT/sbif/out.ms2 {-color Gold -height 16} /scoreboard_tb/DUT/sbif/out.ms3 {-color Gold -height 16} /scoreboard_tb/DUT/sbif/out.gemm_new_weight {-color Gold -height 16} /scoreboard_tb/DUT/sbif/out.spec {-color Gold -height 16} /scoreboard_tb/DUT/sbif/out.halt {-color Gold -height 16}} /scoreboard_tb/DUT/sbif/out
...
add wave -noupdate -expand -group diif -expand /scoreboard_tb/DUT/diif/out
...
add wave -noupdate -radix unsigned -childformat {{/scoreboard_tb/DUT/IS/FS/fuif/fust.busy -radix unsigned} {/scoreboard_tb/DUT/IS/FS/fuif/fust.t1 -radix unsigned} {/scoreboard_tb/DUT/IS/FS/fuif/fust.t2 -radix unsigned} {/scoreboard_tb/DUT/IS/FS/fuif/fust.op -radix unsigned -childformat {{{[2]} -radix unsigned -childformat {{rd -radix unsigned} {rs1 -radix unsigned} {rs2 -radix unsigned} {imm -radix unsigned} {spec -radix unsigned} {i_type -radix unsigned} {op_type -radix unsigned} {mem_type -radix unsigned} {j_type -radix unsigned}}} {{[1]} -radix unsigned -childformat {{rd -radix unsigned} {rs1 -radix unsigned} {rs2 -radix unsigned} {imm -radix unsigned} {spec -radix unsigned} {i_type -radix unsigned} {op_type -radix unsigned} {mem_type -radix unsigned} {j_type -radix unsigned}}} {{[0]} -radix unsigned -childformat {{rd -radix unsigned} {rs1 -radix unsigned} {rs2 -radix unsigned} {imm -radix unsigned} {spec -radix unsigned} {i_type -radix unsigned} {op_type -radix unsigned} {mem_type -radix unsigned} {j_type -radix unsigned}}}}}} -expand -subitemconfig {/scoreboard_tb/DUT/IS/FS/fuif/fust.busy {-height 16 -radix unsigned} /scoreboard_tb/DUT/IS/FS/fuif/fust.t1 {-height 16 -radix unsigned} /scoreboard_tb/DUT/IS/FS/fuif/fust.t2 {-height 16 -radix unsigned} /scoreboard_tb/DUT/IS/FS/fuif/fust.op {-height 16 -radix unsigned -childformat {{{[2]} -radix unsigned -childformat {{rd -radix unsigned} {rs1 -radix unsigned} {rs2 -radix unsigned} {imm -radix unsigned} {spec -radix unsigned} {i_type -radix unsigned} {op_type -radix unsigned} {mem_type -radix unsigned} {j_type -radix unsigned}}} {{[1]} -radix unsigned -childformat {{rd -radix unsigned} {rs1 -radix unsigned} {rs2 -radix unsigned} {imm -radix unsigned} {spec -radix unsigned} {i_type -radix unsigned} {op_type -radix unsigned} {mem_type -radix unsigned} {j_type -radix unsigned}}} {{[0]} -radix unsigned -childformat {{rd -radix unsigned} {rs1 -radix unsigned} {rs2 -radix unsigned} {imm -radix unsigned} {spec -radix unsigned} {i_type -radix unsigned} {op_type -radix unsigned} {mem_type -radix unsigned} {j_type -radix unsigned}}}} -expand} {/scoreboard_tb/DUT/IS/FS/fuif/fust.op[2]} {-radix unsigned -childformat {{rd -radix unsigned} {rs1 -radix unsigned} {rs2 -radix unsigned} {imm -radix unsigned} {spec -radix unsigned} {i_type -radix unsigned} {op_type -radix unsigned} {mem_type -radix unsigned} {j_type -radix unsigned}}} {/scoreboard_tb/DUT/IS/FS/fuif/fust.op[2].rd} {-radix unsigned} {/scoreboard_tb/DUT/IS/FS/fuif/fust.op[2].rs1} {-radix unsigned} {/scoreboard_tb/DUT/IS/FS/fuif/fust.op[2].rs2} {-radix unsigned} {/scoreboard_tb/DUT/IS/FS/fuif/fust.op[2].imm} {-radix unsigned} {/scoreboard_tb/DUT/IS/FS/fuif/fust.op[2].spec} {-radix unsigned} {/scoreboard_tb/DUT/IS/FS/fuif/fust.op[2].i_type} {-radix unsigned} {/scoreboard_tb/DUT/IS/FS/fuif/fust.op[2].op_type} {-radix unsigned} {/scoreboard_tb/DUT/IS/FS/fuif/fust.op[2].mem_type} {-radix unsigned} {/scoreboard_tb/DUT/IS/FS/fuif/fust.op[2].j_type} {-radix unsigned} {/scoreboard_tb/DUT/IS/FS/fuif/fust.op[1]} {-radix unsigned -childformat {{rd -radix unsigned} {rs1 -radix unsigned} {rs2 -radix unsigned} {imm -radix unsigned} {spec -radix unsigned} {i_type -radix unsigned} {op_type -radix unsigned} {mem_type -radix unsigned} {j_type -radix unsigned}}} {/scoreboard_tb/DUT/IS/FS/fuif/fust.op[1].rd} {-radix unsigned} {/scoreboard_tb/DUT/IS/FS/fuif/fust.op[1].rs1} {-radix unsigned} {/scoreboard_tb/DUT/IS/FS/fuif/fust.op[1].rs2} {-radix unsigned} {/scoreboard_tb/DUT/IS/FS/fuif/fust.op[1].imm} {-radix unsigned} {/scoreboard_tb/DUT/IS/FS/fuif/fust.op[1].spec} {-radix unsigned} {/scoreboard_tb/DUT/IS/FS/fuif/fust.op[1].i_type} {-radix unsigned} {/scoreboard_tb/DUT/IS/FS/fuif/fust.op[1].op_type} {-radix unsigned} {/scoreboard_tb/DUT/IS/FS/fuif/fust.op[1].mem_type} {-radix unsigned} {/scoreboard_tb/DUT/IS/FS/fuif/fust.op[1].j_type} {-radix unsigned} {/scoreboard_tb/DUT/IS/FS/fuif/fust.op[0]} {-radix unsigned -childformat {{rd -radix unsigned} {rs1 -radix unsigned} {rs2 -radix unsigned} {imm -radix unsigned} {spec -radix unsigned} {i_type -radix unsigned} {op_type -radix unsigned} {mem_type -radix unsigned} {j_type -radix unsigned}}} {/scoreboard_tb/DUT/IS/FS/fuif/fust.op[0].rd} {-radix unsigned} {/scoreboard_tb/DUT/IS/FS/fuif/fust.op[0].rs1} {-radix unsigned} {/scoreboard_tb/DUT/IS/FS/fuif/fust.op[0].rs2} {-radix unsigned} {/scoreboard_tb/DUT/IS/FS/fuif/fust.op[0].imm} {-radix unsigned} {/scoreboard_tb/DUT/IS/FS/fuif/fust.op[0].spec} {-radix unsigned} {/scoreboard_tb/DUT/IS/FS/fuif/fust.op[0].i_type} {-radix unsigned} {/scoreboard_tb/DUT/IS/FS/fuif/fust.op[0].op_type} {-radix unsigned} {/scoreboard_tb/DUT/IS/FS/fuif/fust.op[0].mem_type} {-radix unsigned} {/scoreboard_tb/DUT/IS/FS/fuif/fust.op[0].j_type} {-radix unsigned}} /scoreboard_tb/DUT/IS/FS/fuif/fust
...
add wave -noupdate /scoreboard_tb/DUT/sbif/jump
TreeUpdate [SetDefaultTree]
WaveRestoreCursors {{Cursor 3} {79910 ps} 1} {{Cursor 4} {421820 ps} 0}
...
update
WaveRestoreZoom {1610 ps} {678860 ps}
