...
VL_ATTR_COLD void VMAC_unit_tb___024root___ctor_var_reset(VMAC_unit_tb___024root* vlSelf) {
    ...
    vlSelf->MAC_unit_tb__DOT__dut__DOT__input_x = VL_RAND_RESET_I(16);
    vlSelf->MAC_unit_tb__DOT__dut__DOT__nxt_input_x = VL_RAND_RESET_I(16);
    ...
    vlSelf->MAC_unit_tb__DOT__dut__DOT__add1__DOT__diff = VL_RAND_RESET_I(6);
    ...
    vlSelf->MAC_unit_tb__DOT__dut__DOT__add3__DOT__u_exp1 = VL_RAND_RESET_I(6);
    vlSelf->MAC_unit_tb__DOT__dut__DOT__add3__DOT__u_shifted_amount = VL_RAND_RESET_I(6);
    vlSelf->MAC_unit_tb__DOT__dut__DOT__add3__DOT__u_result = VL_RAND_RESET_I(6);
    vlSelf->MAC_unit_tb__DOT__dut__DOT__add3__DOT__round_this = VL_RAND_RESET_I(12);
    vlSelf->MAC_unit_tb__DOT__dut__DOT__add3__DOT__round_flag = VL_RAND_RESET_I(1);
    vlSelf->MAC_unit_tb__DOT__dut__DOT__add3__DOT__rounded_fraction = VL_RAND_RESET_I(12);
