...
#endif
            VL_FATAL_MT("src/testbench/systolic_array_tb.sv", 11, "", "NBA region did not converge.");
        }
...
#endif
                VL_FATAL_MT("src/testbench/systolic_array_tb.sv", 11, "", "Active region did not converge.");
            }
