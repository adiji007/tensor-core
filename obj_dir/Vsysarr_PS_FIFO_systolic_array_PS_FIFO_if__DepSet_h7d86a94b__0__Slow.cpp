...
VL_ATTR_COLD void Vsysarr_PS_FIFO_systolic_array_PS_FIFO_if___ctor_var_reset(Vsysarr_PS_FIFO_systolic_array_PS_FIFO_if* vlSelf) {
    (void)vlSelf;  // Prevent unused variable warning
    Vsysarr_PS_FIFO__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+          Vsysarr_PS_FIFO_systolic_array_PS_FIFO_if___ctor_var_reset\n"); );
