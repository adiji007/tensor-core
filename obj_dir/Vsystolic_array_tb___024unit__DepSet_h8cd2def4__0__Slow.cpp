...
VL_ATTR_COLD void Vsystolic_array_tb___024unit___ctor_var_reset(Vsystolic_array_tb___024unit* vlSelf) {
    (void)vlSelf;  // Prevent unused variable warning
    Vsystolic_array_tb__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+        Vsystolic_array_tb___024unit___ctor_var_reset\n"); );
