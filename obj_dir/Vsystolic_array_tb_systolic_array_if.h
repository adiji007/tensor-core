...
class alignas(VL_CACHE_LINE_BYTES) Vsystolic_array_tb_systolic_array_if final : public VerilatedModule {
  public:
    ...
    CData/*0:0*/ __PVT__weight_en;
    CData/*0:0*/ __PVT__input_en;
    CData/*0:0*/ __PVT__partial_en;
    CData/*0:0*/ __PVT__out_en;
    CData/*0:0*/ __PVT__drained;
    CData/*1:0*/ __PVT__row_in_en;
    CData/*1:0*/ __PVT__row_ps_en;
    CData/*1:0*/ __PVT__row_out;
    QData/*63:0*/ __PVT__array_in;
    QData/*63:0*/ __PVT__array_in_partials;
    QData/*63:0*/ __PVT__array_output;
